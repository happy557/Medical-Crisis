...
<?php 
	...
	<!-- //header -->
		...
		<section class="login-page">
			...
			<div class="login">
				<div class="container">
					<h3>Current Location Here</h3>
					<div class="login-form-grids">
                                            <form method="post" action="" enctype="multipart/form-data">
                                                                    <label class="test-info">Name <span>*</span></label>
                                                                    <input type="text" placeholder="Enter Username" name="name" required=" " >
									<label class="test-info">Reachtime <span>*</span></label>
                                                                        <input type="text" placeholder="" name="reachtime" value="" required=" " readonly="" >
									<div class="clearfix"></div>
                                                                        <label class="test-info">Phone No <span>*</span></label>
                                                                        <input type="text" placeholder="" name="number" value="<?php echo $ph;?>" required=" " readonly="" >
									<div class="clearfix"></div>
