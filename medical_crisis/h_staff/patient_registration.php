...
$qd=  mysqli_query($con, "select *from staff where Username='$name'");
...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="home.php">Home</a><i class="fa fa-angle-right"></i>Patients <i class="fa fa-angle-right"></i>Add Patients</li>
            </ol>
...
<h3>Add Patients</h3>	
  <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
                                                    <form class="form-horizontal" method ="post" action="patient_code.php">
                                                        <div class="form-group">
									<label for="Title" class="col-sm-3 control-label">Department</label>
									<div class="col-sm-7">
                                                                            <input type="text" name="sltdept" readonly="" class="form-control" value="<?php echo $dept;?>" />
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
                                                            ...
                                                            <div class="form-group">
									<label for="Title" class="col-sm-3 control-label">Contact</label>
									<div class="col-sm-7">
                                                                            <input type="text" name="txtcont" class="form-control" value=""/>
									</div>
									...
									<div class="col-sm-7">
                                                             ...
                                                             <div class="form-group">
									<label for="Title" class="col-sm-3 control-label">District</label>
									<div class="col-sm-7">
...
<div class="w3l-table-info" style="margin-left: -320px;">
					  <h2>View Patient List</h2>
						...
						<tbody>
						  <?php
                                                  $qr="select * from patient_reg where Hospital='$hid' order by Id desc";
                                                    ...
                                                    <tr>
                                                       ...
                                                       ?>
                                                        ...
                                                        <td><?php echo $r['Status'];?></td>
                                                         ...
                                                         {
                                                         ?>
                                                         <td><a href="patientstatus.php?id=<?php echo $r['Id'];?>">Discharge</a></td>
                                                         <?php
                                                         }
                                                        ...
                                                        <td><a href="delpatient.php?id=<?php echo $r['Id'];?>"><input type="button" name="btn" value="delete" onclick="alert('are you sure want to delete??')"></a></td>
                                                    </tr>
                                                    <?php
