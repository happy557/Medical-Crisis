...
$hid=$r1['Hospital'];
$dept=$r1['Department'];
 $qdd2=  mysqli_query($con, "select *from hospial where Id='$hid'");
$r2=  mysqli_fetch_array($qdd2);
?>
<!DOCTYPE HTML>
...
<h3>Add facilities</h3>	
  <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
									...
									<div class="col-sm-7">
                                                                            <input type="text" name="sltdept" readonly="" class="form-control" value="<?php echo $r2['Hospital'];?>" />
