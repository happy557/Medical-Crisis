...
<div class="w3l-table-info" style="margin-left: -320px; overflow-x: auto;">
					  <h2>View Emergency Posting</h2>
						...
						<tbody>
						  <?php
                                                  $qr="select  *from emergency order by Id desc";
                                                  ...
                                                  ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $r['Ac_loc'];?></td>
                                                         <td><?php echo $r['Ac_city'];?></td>

                                                           <td><?php echo $r['Ac_des'];?></td>
                                                           <td><a href="../<?php echo $r['Photo'];?>" target="_blank"><img src="../<?php echo $r['Photo'];?>" width="60" height="60"/></a></td>
