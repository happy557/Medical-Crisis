						...
						<div class="w3agile-validation w3ls-validation">
							<div class="panel panel-widget agile-validation register-form">
								<div class="validation-grids widget-shadow" data-example-id="basic-forms"> 
                                    ...
                                    {
                                        ?>
                                    <marquee scroll aamount="1">your registration saved sucesfully.After activation you can enter in to this site.."</marquee>
                                      <?php
                                      }
                                    if(isset($_GET['p']))
                                    {
...
onfocus="this.removeAttribute('readonly');" type="email" class="form-control" name="Email" placeholder="Email" data-error="That email address is invalid" required="">
											...
											<div class="form-group">
                                                                           ...
                                                                           $password=$_POST['password'];
                                                                             ...
                                                                             $q="insert into patient(Conatct,District,Aadhaar,Email,Status,Usertype,Password)values('$phone','$district','$city','$Email','Inactive','user','$password')";
                                                                             $qr=  mysqli_query($con,$q);
                                                                              $qy="insert into login(Username,Password,Usertype,Status)values('$Email','$password','user','Active')";
                                                                                        $qyy=  mysqli_query($con,$qy);
                                                                              header("location:registration.php?s=1");
                                                                              }
                                                                            }
                                                                            ?>
												...
												<div class="bottom">
													...
													<div class="clearfix"> </div>
                                                                                    ...
                                                                                    if(isset($_POST['login']))
                                                                                    {
                                                                                        ...
                                                                                        if($r9['Usertype']=='user' and $r9['Status']=='Active')
                                                                                        {
                                                                                            $_SESSION['admin']=$r9;
