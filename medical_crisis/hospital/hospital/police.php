								...
								<div class="validation-grids widget-shadow" data-example-id="basic-forms"> 
									...
									<div class="form-body form-body-info">
										<form  action="#" method="post">
												...
												<input type="text" class="form-control" id="inputName" name="hname" placeholder="Police Station Name" required="">
											</div>
                                                                                    <div class="form-group valid-form">
												<input type="text" class="form-control" autocomplete="off" readonly 
onfocus="this.removeAttribute('readonly');" id="inputName" name="address" placeholder="Police Station Address" required="">
											</div>
                                                                                    <div class="form-group valid-form">
												<input type="text" class="form-control" id="inputName" name="phone" placeholder="Police Station Contact Number" required="">
											</div>
                                                                                     <div class="form-group valid-form">
                                                                                    ...
                                                                                    <div class="form-group valid-form">
												<input type="text" class="form-control" id="inputName" name="city" placeholder="Police Station City" required="">
											</div>
											...
											<div class="form-group">
                                                                            ...
                                                                            if(isset($_POST['sub']))
                                                                            {
                                                                             ...
                                                                             $q="insert into police_registration(Hname,Haddress,Conatct,District,City,Email,Password,Status,Usertype)values('$hname','$address','$phone','$district','$city','$Email','$Password','Active','Police')";
                                                                             $qr=  mysqli_query($con,$q);
                                                                                $qy="insert into login(Username,Password,Usertype,Status)values('$Email','$Password','Police','Active')";
                                                                                        $qyy=  mysqli_query($con,$qy);
                                                                              header("location:police.php?s=1");
                                                                              }
                                                                            }
                                                                            ?>
												...
												<div class="bottom">
													...
													<div class="clearfix"> </div>
                                                                                    ...
                                                                                    if(isset($_POST['login']))
                                                                                    {
                                                                                        ...
                                                                                        if($r9['Usertype']=='Police' and $r9['Status']=='Active')
                                                                                        {
                                                                                            $_SESSION['admin']=$r9;
