...
<div class="w3l-table-info" style="margin-left: -320px;">
					  <h2>View Doctors List</h2>
						...
						<tbody>
						  <?php
                                                  $qr="select * from doctor where Hospital='$hid' order by Id desc";
                                                  ...
                                                  ?>
                                                    <tr>
                                                       ...
                                                       ?>
                                                        ...
                                                        <td><a href="deldoctor.php?id=<?php echo $r['Id'];?>"><input type="button" name="btn" value="delete" onclick="alert('are you sure want to delete??')"></a></td>
                                                    </tr>
                                                    <?php
