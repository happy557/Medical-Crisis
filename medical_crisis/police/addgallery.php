...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="home.php">Home</a><i class="fa fa-angle-right"></i>Gallery <i class="fa fa-angle-right"></i>Add Gallery</li>
            </ol>
...
<h3>Add Gallery</h3>	
  <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" method ="post" action="addgallerycode.php"  enctype="multipart/form-data">
								...
								<div class="form-group">
									<label for="  Add caption:" class="col-sm-2 control-label">  Add caption:</label>
									<div class="col-sm-8">
										<input type="text" name="txtcaption" type="text" class="form-control1"  placeholder="Caption">
									</div>
								</div>
		...
		<div class="row">
			<div class="col-sm-8 col-sm-offset-2">
				<input type="submit" class="btn-primary btn" name="s1" value="SUBMIT">
				<input type="submit" class="btn-danger btn" value="CANCEL">
