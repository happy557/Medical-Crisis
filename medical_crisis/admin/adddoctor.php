...
<h3>Add Doctors</h3>	
  <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
                                                    <form class="form-horizontal" method ="post" action="adddoctor_code.php">
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
                                                            ...
                                                            <div class="form-group">
									<label for="Title" class="col-sm-3 control-label">Doctor Name</label>
									<div class="col-sm-7">
                                                              ...
                                                              <div class="form-group">
									<label for="Title" class="col-sm-3 control-label">Doctor Description</label>
									<div class="col-sm-7">
...
<div class="w3l-table-info" style="margin-left: -320px;">
					  <h2>View Doctors List</h2>
						...
						<tbody>
						  <?php
                                                  $qr="select * from doctor order by Id desc";
                                                  ...
                                                  ?>
                                                    <tr>
                                                       ...
                                                       ?>
                                                        ...
                                                        <td><a href="deldoctor.php.php?id=<?php echo $r['Id'];?>"><input type="button" name="btn" value="delete" onclick="alert('are you sure want to delete??')"></a></td>
                                                    </tr>
                                                    <?php
