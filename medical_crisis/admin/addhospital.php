...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="home.php">Home</a><i class="fa fa-angle-right"></i>Hospital <i class="fa fa-angle-right"></i>Add Hospital</li>
            </ol>
...
<h3>Add Hospital</h3>	
  <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
                                                    <form class="form-horizontal" method ="post" action="addhosp_code.php">
								<div class="form-group">
									<label for="Title" class="col-sm-3 control-label">Hospital Name</label>
									<div class="col-sm-7">
                                                                            <input type="text" name="txthos" class="form-control" value=""/>
									</div>
...
<div class="w3l-table-info" style="margin-left: -320px;">
					  <h2>View Hospital Details</h2>
						...
						<tbody>
						  <?php
                                                  $qr="select * from hospial order by Id desc";
                                                  ...
                                                  ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $r['Des'];?></td>
                                                                <td><a href="delhospital.php?id=<?php echo $r['Id'];?>"><input type="button" name="btn" value="delete" onclick="alert('are you sure want to delete??')"></a></td>
                                                    </tr>
                                                    <?php
