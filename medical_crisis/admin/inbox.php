...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php">Home</a><i class="fa fa-angle-right"></i>Registration <i class="fa fa-angle-right"></i>View Details</li>
            </ol>
...
<div class="w3l-table-info" style="margin-left: -320px;">
					  <h2>View Registered Candidates</h2>
						...
						<tbody>
						  <?php
                                                  $qr="select registration.Name,registration.Address,registration.Gender,registration.Email,registration.Phone,registration.Mobile,registration.City,registration.State,registration.Country,registration.Username,registration.Password,login.Status,login.Id from registration INNER JOIN login ON registration.Username=login.Username";
                                                  $qrr=  mysql_query($qr);
                                                  $i=1;
                        ...
                        <input type="submit" name="s2" value="Active">
