...
<!--heder end here-->
<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="home.php">Home</a><i class="fa fa-angle-right"></i>Testimonial <i class="fa fa-angle-right"></i>View Testimonial</li>
            </ol>
...
<!--                                                        <td><input type="hidden" name="eid" value="<?php echo $r['Id'];?>"/>
                       ...
                       <input type="submit" name="s2" value="Active"></td>-->
                                                     ...
                                                     <?php
                                                         ...
                                                         {
                                                         ?>
                                                         <td><a href="testimonialactive.php?id=<?php echo $r['Id'];?>&sts=<?php echo $r['Status'];?>">Active</a></td>
                                                         <?php
                                                         }
                                                         elseif ($r['Status']=='Active') {
                                                         ?>
                                                     <td><a href="testimonialactive.php?idd=<?php echo $r['Id'];?>&&stts=<?php echo $r['Status'];?>">Inactive</a></td>
                                            ...
                                            <!-- <td><a href="testimonialedit.php?id=<?php echo $r['Id'];?>">Edit</a></td>-->
                                                        <td><a href="testimonialdelete.php?id=<?php echo $r['Id'];?>&path=<?php echo $r['Image'];?>"><input type="button" name="btn" value="delete" onclick="alert('are you sure want to delete??')"></a></td>
                                                        <td></td>
...
if(isset($_POST['s1']))
{
   $iid=$_POST['eid'];
    ...
    $qy="update testimonial set Status='Inactive' where Id='$iid'";
    $qyy=mysql_query($qy);
...
{
    $iiid=$_POST['eid'];
    $qy1="update testimonial set Status='Active' where Id='$iiid'";
