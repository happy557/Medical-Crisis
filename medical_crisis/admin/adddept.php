...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="home.php">Home</a><i class="fa fa-angle-right"></i>Department <i class="fa fa-angle-right"></i>Add Department</li>
            </ol>
...
<h3>Add Department</h3>	
  <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
                                                    <form class="form-horizontal" method ="post" action="adddept_code.php">
								<div class="form-group">
									<label for="Title" class="col-sm-3 control-label">Hospital Name</label>
									<div class="col-sm-7">
                                                                            <select name="slthos" class="form-control" >
                                                                                <option>Choose Hospital</option>
                                                                                <?php 
                                                                                $qs=  mysqli_query($con, "select *from hospial order by Id desc");
                                                                                while ($r1=  mysqli_fetch_array($qs))
                                                                                {
                                                                                ?>
                                                                                <option value="<?php echo $r1['Id'];?>"><?php echo $r1['Hospital'];?></option>
                                                                                <?php 
                                                                                }
                                                                                ?>
                                                                            </select>
                                                            ...
                                                            <div class="form-group">
									<label for="Title" class="col-sm-3 control-label">Department Name</label>
									<div class="col-sm-7">
                                                                            <input type="text" name="txtdept" class="form-control" value=""/>
									</div>
...
<div class="w3l-table-info" style="margin-left: -320px;">
					  <h2>View department Details</h2>
						...
						<tbody>
						  <?php
                                                  $qr="select * from department order by Id desc";
                                                  ...
                                                  ?>
                                                    <tr>
                                                        ...
                                                        <td><a href="deldept.php?id=<?php echo $r['Id'];?>"><input type="button" name="btn" value="delete" onclick="alert('are you sure want to delete??')"></a></td>
                                                    </tr>
                                                    <?php
