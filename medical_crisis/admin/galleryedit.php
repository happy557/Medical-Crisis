...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="home.php">Home</a><i class="fa fa-angle-right"></i>Crafts <i class="fa fa-angle-right"></i>Add Crafts</li>
            </ol>
...
{
    $id=$_GET['id'];
   $qr="select * from galleryadd where Id='$id'";
   $qry=mysql_query($qr);
  ...
  <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
								...
								<div class="form-group">
									<label for="Caption" class="col-sm-2 control-label">Image</label>
									<div class="col-sm-8">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
                                                                            <input type="text" value="<?php echo $r['Caption'];?>" name="txtcaption" class="form-control1"  >
									</div>
								</div>
		...
		<div class="row">
			<div class="col-sm-8 col-sm-offset-2">
                            <input type="hidden" name="eid" value="<?php echo $r['Id'];?>">
...
if($filename=='')
{
 $filepath=$old;   
    ...
    move_uploaded_file($f,"gallery/".$filename);
    $path="gallery/";
...
$qy="update galleryadd set Caption='$caption',Image='$filepath' where Id='$iid'";
$qyy=  mysql_query($qy);
...
<div class="copyrights" style="margin-left: -320px;">
	 <p>© 2016 Infotech . All Rights Reserved | Design by  <a href="http://codsinfotech.com/" target="_blank">kodsinfotech</a> </p>
</div>	
