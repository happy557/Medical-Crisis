            ...
            <!--header start here-->
				<div class="header-main">
					<div class="logo-w3-agile" style="background:#008DE7;"> 
								<h1><a href="home.php">Medical Crisis</a></h1>
							</div>
...
<div class="w3l-table-info" style="margin-left: -320px; overflow-x: auto;">
					  <h2>View complaints</h2>
						...
						<tbody>
						  <?php
                                                  $qr="select  *from complaints order by Id desc";
...
<div class="copyrights" style="margin-left: -320px;">
	 <p>© 2021 KodzInfotech . All Rights Reserved | Design by  <a href="http://kodsinfotech.com/" target="_blank">kodsinfotech</a> </p>
</div>	
