						  ...
						  <?php
                                                  ...
                                                  ?>
                                                     <tr>
                                                        ...
                                                        <td><a href="galleryedit.php?id=<?php echo $r['Id'];?>">Edit</a></td>
                                                        <td><a href="gallerydelete.php?id=<?php echo $r['Id'];?>&path=<?php echo $r['Image'];?>"><input type="button" name="btn" value="delete" onclick="alert('are you sure want to delete??')"></a></td>
                                                    </tr>
                                                    <?php
