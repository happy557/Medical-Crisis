...
{
    $id=$_GET['id'];
   $qr="select * from testimonial where Id='$id'";
   $qry=mysql_query($qr);
  ...
  <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
                                                                            <input type="text" value="<?php echo $r['Name'];?>" name="txtname" class="form-control1"  >
									</div>
								</div>
								<div class="form-group">
									<label for="Comment" class="col-sm-2 control-label">Comment</label>
									<div class="col-sm-8">
                                                                            <textarea name="txtcomment" class="form-control1" ><?php echo $r['Comment'];?></textarea>
									</div>
...
$qy="update testimonial set Image='$filepath',Name='$name',Comment='$comment' where Id='$iid'";
$qyy=  mysql_query($qy);
